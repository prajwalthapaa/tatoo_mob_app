...
import 'package:tattoo_booking_app/presentation/pages/BookingPage.dart';
...
void main() {
  ...
  testWidgets('BookingPage displays tattoo details and date picker', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(MaterialApp(home: BookingPage(tattooId: '1', tattooName: 'Tattoo Design 1')));
  ...
  testWidgets('Confirm Booking button shows correct SnackBar when date is selected', (WidgetTester tester) async {
    ...
    expect(
      find.text('Booking confirmed for Tattoo Design 1 on ${DateFormat.yMMMd().format(selectedDate)}'),
      findsOneWidget,
    );
  });
